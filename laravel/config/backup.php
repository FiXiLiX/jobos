...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             */
            'databases' => [
                // Database backups disabled - SSL requirement issue with spatie/db-dumper
                // The library uses credentials file approach which doesn't respect my.cnf [mysqldump] section
                // File-only backups provide complete application protection
            ],
        ],
